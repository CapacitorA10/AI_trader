        ...
        if step % 2000 == 0:
            ...
            with torch.no_grad():
                ...
                for data in test_loader:
                    ...
                    writer.add_scalar("REAL/GOLD", data.squeeze()[-1, 0], v_step)
                    writer.add_scalar("REAL/NSDQ", data.squeeze()[-1, 1], v_step)
                    writer.add_scalar("REAL/TRES", data.squeeze()[-1, 2], v_step)
